...
<body>
 ...
 <a  class="letraTitulo">En qué horario desea ser contactado?
    ...
    <li></li>
    <li></li>
    <li><div class="cuadro" style="text-align:right;"><asp:Image ID="Image5" CssClass="cuadro" runat="server" Height="94px" ImageUrl="http://cotizador.unitypromotores.com/Cotizador/imagenes/logo_telus.jpg" Width="200px" /></div></li> 
       </ul>
    </div>
