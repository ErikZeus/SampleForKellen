...
namespace Cotizador
{
    public partial class PeticionesExternas6 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
          ...
          if (tiposeguro == "Seguro Completo")
          {
              ...
              if (moto == 7)
              {
                  Response.Redirect("Rpt23.aspx");
              }
              else
              {
                  Response.Redirect("Rpt21.aspx");
              }
          }
          else {
              ...
              if (moto == 7)
              {
                  Response.Redirect("Rpt24.aspx"); 
              }
              else
              {
                  Response.Redirect("Rpt22.aspx");
              }
