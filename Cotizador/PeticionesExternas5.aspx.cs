...
namespace Cotizador
{
    public partial class PeticionesExternas5 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
          ...
          if (tiposeguro == "Seguro Completo")
          {
              ...
              if (moto == 7)
              {
                  Response.Redirect("Rpt19.aspx");
              }
              else
              {
                  Response.Redirect("Rpt17.aspx");
              }
          }
          else {
              ...
              if (moto == 7)
              {
                  Response.Redirect("Rpt20.aspx"); 
              }
              else
              {
                  Response.Redirect("Rpt18.aspx");
              }
