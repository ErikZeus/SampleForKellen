<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Formulario4.aspx.cs" Inherits="Cotizador.Formulario4" %>
...
<body>
    ...
    <li></li>
    <li></li>
    <li><div class="cuadro"><asp:Image ID="Image5" CssClass="cuadro" runat="server" Height="94px" ImageUrl="http://testcotizador.unitypromotores.com/Cotizador/imagenes/LogoBlancoTransparenteCapgemini.png" Width="275px" /></div></li> 
       </ul>
    </div>
