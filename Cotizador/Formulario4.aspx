...
<body>
    ...
    <li></li>
    <li></li>
    <li><div class="cuadro"><asp:Image ID="Image5" CssClass="cuadro" runat="server" Height="94px" ImageUrl="http://cotizador.unitypromotores.com/Cotizador/imagenes/LogoBlancoTransparenteCapgemini.png" Width="275px" /></div></li> 
       </ul>
    </div>
