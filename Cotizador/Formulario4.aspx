...
<a  class="letraTitulo">En qué horario desea ser contactado?
    ...
    <li></li>
    <li></li>
    <li><div class="cuadro"><asp:Image ID="Image5" CssClass="cuadro" runat="server" Height="94px" ImageUrl="http://localhost/Cotizador/imagenes/LogoBlancoTransparenteCapgemini.png" Width="275px" /></div></li> 
       </ul>
    </div>
