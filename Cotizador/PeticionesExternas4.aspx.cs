...
namespace Cotizador
{
    public partial class PeticionesExternas4 : System.Web.UI.Page
    {
...
//TEST
          if (tiposeguro == "Seguro Completo")
          {
              ...
              if (moto == 7)
              {
                  Response.Redirect("Rpt15.aspx");
              }
              else
              {
                  Response.Redirect("Rpt13.aspx");
              }
          }
          else {
              ...
              if (moto == 7)
              {
                  Response.Redirect("Rpt16.aspx"); 
              }
              else
              {
                  Response.Redirect("Rpt14.aspx");
              }
