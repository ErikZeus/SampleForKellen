...
<body>
    ...
    <li></li>
    <li></li>
    <li><div class="cuadro" style="text-align:right;"><asp:Image ID="Image5" CssClass="cuadro" runat="server" Height="74px" ImageUrl="http://localhost/Cotizador/imagenes/logo_codisa.jpeg" Width="163px" /></div></li> 
       </ul>
    </div>
