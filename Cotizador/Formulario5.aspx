...
<body>
    ...
    <li></li>
    <li></li>
    <li><div class="cuadro" style="text-align:right;"><asp:Image ID="Image5" CssClass="cuadro" runat="server" Height="94px" ImageUrl="http://cotizador.unitypromotores.com/Cotizador/imagenes/ColegioEstomatologico.png" Width="94px" /></div></li> 
       </ul>
    </div>
